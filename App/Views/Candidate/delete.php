...
<div class="box box-solid">
    <div class="box-header with-border">
        <h3 class="box-title">Do you want to delete this Candidate?</h3>
    </div>
    <div class="box-body">
        <dl class="dl-horizontal">
            <dt>Candidate Title:</dt>
            <dd><?php echo $candidate->title; ?></dd>
        </dl>
    </div>
    <div class="box-footer">
        <form method="post" action="<?php echo BASE_URL . PANEL; ?>/candidate/delete/<?php echo $candidate->id ?>">
