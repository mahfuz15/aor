                        ...
                        <div class="row text-right">
                            <form class="form-inline">
                                <div class="col-lg-2 col-md-3 col-sm-4">
                                    <div class="input-group input-group-sm">
                                        ...
                                        <div class="input-group-btn">
                                            ...
                                            <a href="<?php echo BASE_URL . PANEL; ?>/roles/" class="btn btn-default btn-sm">
                                ...
                                <div class="col-lg-4 col-md-3 col-sm-4 pull-right">
                                    <a href="<?= BASE_URL . PANEL; ?>/role/add" class="btn btn-success btn-sm">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            if (!empty($this->values["roles"])):
                                foreach ($roles as $role):
                                    $link = BASE_URL . PANEL . '/role/edit/' . $role->id;
                                    ?>
                                    <tr>
                                        <td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a class="popup btn btn-danger btn-xs color-white" href="<?= BASE_URL . PANEL; ?>/role/delete/<?php echo $role->id; ?>">
